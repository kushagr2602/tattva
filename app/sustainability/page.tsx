...
export const metadata: Metadata = {
  ...
  description: "Why silver gifting doesn't get thrown away: reusable, refillable, and built to last for years.",
};
    ...
    <>
      <section className="page-head on-dark">
        <div className="wrap">
          ...
          <p className="page-head-sub">
            The most sustainable gift is the one that never gets thrown away. A Tattva piece is made to be exactly that.
          </p>
        </div>
      </section>
      ...
      <section className="wrap prose reveal">
        <p>
          ...
          a box that goes straight to the bin the next morning. A Tattva gift is the opposite. The metal
          doesn&apos;t rust or fade, the box that arrives full of mithai becomes the box on the
          dresser; the thali comes back out every Diwali; the platter keeps serving guests for years.
        </p>
      </section>
      ...
      <section className="wrap value-grid reveal">
        ...
        <Value title="Built to outlast us" body="A hard-wearing alloy made to last generations, the kind of thing that becomes a family heirloom, not landfill." />
        <Value title="A second life" body="Every piece in the catalogue lists how it gets reused after the occasion. We pick pieces that stay useful at home." />
      </section>

      <section className="wrap prose reveal">
        <h2 className="prose-h">Caring for silver</h2>
        <p>
